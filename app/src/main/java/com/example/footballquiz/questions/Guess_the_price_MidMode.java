...
public class Guess_the_price_MidMode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guess_the_price_mid_mode);

        next_button = findViewById(R.id.next_button_guess_the_price);
        return_button = findViewById(R.id.return_button_guess_the_price);
        rating = findViewById(R.id.rating_guess_the_price);
