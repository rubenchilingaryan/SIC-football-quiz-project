...
public class Who_is_more_expensive_MidMode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_who_is_more_expensive_mid_mode);

        return_button = findViewById(R.id.return_button_expensive);
        next_button = findViewById(R.id.next_button_expensive);
        rating = findViewById(R.id.rating_more_expensive);
